...
const navLinks = [
  { label: "Colchões", href: "/galeria/#colchoes" },
      ...
      <header className="hidden md:block fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md shadow-sm transition-all duration-300">
        <div className="max-w-7xl mx-auto px-6 h-20 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-3 flex-shrink-0 hover:opacity-80 transition-opacity">
            ...
            />
            <div>
              <span className="text-sm font-bold text-brand-navy leading-tight block">Ortobom</span>
              <span className="text-xs font-semibold text-brand-blue block">Empório Marista</span>
            </div>
          </Link>
          ...
          <div className="flex items-center gap-4">
            ...
            <a
              href="https://wa.me/5562996148873?text=Oi!%20Vim%20pelo%20site%20da%20Ortobom%20Marista.%20Quero%20ajuda%20para%20escolher%20meu%20colch%C3%A3o%20ideal"
              target="_blank"
              rel="noopener noreferrer"
        ...
        <header className="fixed top-0 left-0 right-0 z-40 bg-white/95 backdrop-blur-md shadow-sm h-16 flex items-center justify-between px-4">
          <Link href="/" className="flex items-center gap-2 flex-shrink-0">
            ...
            <div className="flex flex-col leading-tight">
              <span className="text-xs font-bold text-brand-navy">Ortobom</span>
              <span className="text-xs font-semibold text-brand-blue">Marista</span>
            </div>
          </Link>
          <button
