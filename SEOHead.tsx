...
export default function SEOHead({ page = 'home' }: SEOHeadProps) {
  ...
  const organizationSchema = {
    ...
    "description": "Loja Ortobom em Goiânia. Colchões com entrega rápida (1 dia), 4.9★ no Google, 20 anos no Marista. Consultores com 10+ anos de experiência, estacionamento coberto.",
    "foundingDate": "2004",
    "address": {
      "@type": "PostalAddress",
  ...
  const pageDescription = {
    ...
    produtos: "Colchões Ortobom em Goiânia: Liberty, Ouro Spring, Pro Saúde. Entrega rápida, produtos frescos direto da fábrica. Parcelamento facilitado.",
    contato: "Fale com a Ortobom Goiânia. Av. 85, 2385 - Marista. WhatsApp: (62) 99614-8873. Horário: Seg-Sex 09h-19h, Sáb 09h-13h."
  };
  ...
  return (
    <Helmet>
      ...
      <meta property="og:image" content="https://ortobomgoiania.com.br/og-image.jpg" />
      ...
      <meta name="twitter:image" content="https://ortobomgoiania.com.br/og-image.jpg" />
      
      {/* Keywords (ainda importa para alguns crawlers) */}
      <meta name="keywords" content="colchão goiania, ortobom goiania, colchao marista, loja colchao goiania, colchão ortobom, entrega rapida goiania" />
