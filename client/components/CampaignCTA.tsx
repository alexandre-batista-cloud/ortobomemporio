      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
          <button
            ...
            className="animate-slide-up group flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-brand-blue to-blue-700 text-white font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-lg flex-1 md:flex-initial min-h-[60px]"
          ...
          <a
            ...
            className="animate-slide-up group flex items-center justify-center gap-3 px-10 py-5 bg-gradient-to-r from-brand-green to-green-700 text-white font-bold rounded-xl hover:shadow-2xl hover:scale-105 transition-all duration-300 text-lg flex-1 md:flex-initial min-h-[60px]"
